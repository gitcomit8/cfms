...
const ScoreEntry = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Score Entry</h1>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <>
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-medium text-gray-900">
                Scoring: <span className="text-blue-600">{selectedTeamName}</span>
            ...
            {message && <div className="mb-4 p-3 bg-green-50 text-green-700 rounded-lg border border-green-200 text-sm">{message}</div>}
        ...
        {!selectedTeam && selectedEvent && teams.length === 0 && (
          <p className="text-center text-gray-500 py-6">No teams have registered for this event yet.</p>
        )}
      </div>
    </div>
  );
